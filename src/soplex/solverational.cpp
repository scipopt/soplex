...
void SoPlexBase<Real>::_optimizeRational()
{
   ...
   if(realParam(SoPlexBase<Real>::OBJLIMIT_LOWER) > -realParam(SoPlexBase<Real>::INFTY)
   ...
   if(_status == SPxSolverBase<Real>::OPTIMAL || _status == SPxSolverBase<Real>::INFEASIBLE
         || _status == SPxSolverBase<Real>::UNBOUNDED)
...
typename SPxSolverBase<R>::Status SoPlexBase<R>::_solveRealForRational(bool fromscratch,
      VectorReal& primal, VectorReal& dual,
...
typename SPxSolverBase<R>::Status SoPlexBase<R>::_solveRealStable(bool acceptUnbounded,
      bool acceptInfeasible, VectorReal& primal, VectorReal& dual,
      DataArray< typename SPxSolverBase<R>::VarStatus >& basisStatusRows,
      DataArray< typename SPxSolverBase<R>::VarStatus >& basisStatusCols, bool& returnedBasis,
...
void SoPlexBase<R>::_computeBasisInverseRational()
{
   ...
   if(realParam(SoPlexBase<R>::TIMELIMIT) < realParam(SoPlexBase<R>::INFTY))
      _rationalLUSolver.setTimeLimit(realParam(SoPlexBase<R>::TIMELIMIT) -
