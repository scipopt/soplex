...
public:
  ...
  virtual void getColUnscaled(const SPxLPBase<R>& lp, int i, DSVectorBase<R>& vec) const;
   ...
   virtual Real getColMaxAbsUnscaled(const SPxLPBase<R>& lp, int i) const;
   /// returns minumum absolute value of unscaled column \p i
   virtual Real getColMinAbsUnscaled(const SPxLPBase<R>& lp, int i) const;
   /// returns unscaled upper bound \p i
   virtual Real upperUnscaled(const SPxLPBase<R>& lp, int i) const;
  ...
  virtual void getUpperUnscaled(const SPxLPBase<R>& lp, VectorBase<R>& vec) const;
   ...
   virtual Real lowerUnscaled(const SPxLPBase<R>& lp, int i) const;
  ...
  virtual void getLowerUnscaled(const SPxLPBase<R>& lp, VectorBase<R>& vec) const;
   ...
   virtual Real maxObjUnscaled(const SPxLPBase<R>& lp, int i) const;
  ...
  virtual void getRowUnscaled(const SPxLPBase<R>& lp, int i, DSVectorBase<R>& vec) const;
   ...
   virtual Real getRowMaxAbsUnscaled(const SPxLPBase<R>& lp, int i) const;
   /// returns minimum absolute value of unscaled row \p i
   virtual Real getRowMinAbsUnscaled(const SPxLPBase<R>& lp, int i) const;
   /// returns unscaled right hand side \p i
   virtual Real rhsUnscaled(const SPxLPBase<R>& lp, int i) const;
   ...
   virtual Real lhsUnscaled(const SPxLPBase<R>& lp, int i) const;
   ...
   virtual Real getCoefUnscaled(const SPxLPBase<R>& lp, int row, int col) const;
   ...
   virtual void scaleObj(const SPxLPBase<R>& lp, VectorReal& origObj) const;
   /// returns scaled objective function coefficient \p origObj.
   virtual Real scaleObj(const SPxLPBase<R>& lp, int i, Real origObj) const;
   /// returns scaled LP element in \p row and \p col.
   virtual Real scaleElement(const SPxLPBase<R>& lp, int row, int col, Real val) const;
   /// returns scaled lower bound of column \p col.
   virtual Real scaleLower(const SPxLPBase<R>& lp, int col, Real lower) const;
   /// returns scaled upper bound of column \p col.
   virtual Real scaleUpper(const SPxLPBase<R>& lp, int col, Real upper) const;
   /// returns scaled left hand side of row \p row.
   virtual Real scaleLhs(const SPxLPBase<R>& lp, int row, Real lhs) const;
   /// returns scaled right hand side of row \p row.
   virtual Real scaleRhs(const SPxLPBase<R>& lp, int row, Real rhs) const;
   ...
   virtual Real maxColRatio(const SPxLPBase<R>& lp) const;
   /// maximum ratio between absolute biggest and smallest element in any row.
   virtual Real maxRowRatio(const SPxLPBase<R>& lp) const;
