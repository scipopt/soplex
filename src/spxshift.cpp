...
/*                                                                           */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
#pragma ident "@(#) $Id: spxshift.cpp,v 1.8 2002/01/31 08:19:29 bzfkocht Exp $"
...
#ifndef NDEBUG
   testBounds();
   std::cout << "shiftFvec: OK" << std::endl;
#endif
}
...
#ifndef NDEBUG
   testBounds();
   std::cout << "shiftPvec: OK" << std::endl;
#endif
}
