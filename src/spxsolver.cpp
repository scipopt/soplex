...
void SPxSolver<R>::loadBasis(const SPxBasis::Desc& p_desc)
{
   unInit();
...
SPxSolver<R>::basisStatusToVarStatus( SPxBasis::Desc::Status stat ) const
{
   VarStatus vstat;
...
std::ostream& operator<<( std::ostream& os,
                          const SPxSolver<R>::Representation& status )
{
   switch ( status )
      {
