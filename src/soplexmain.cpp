...
void checkSolutionReal(SoPlex& soplex)
{
   ...
   if(soplex.hasSol())
   {
      ...
      if(soplex.getRedCostViolationReal(redcostviol, sumviol)
            && soplex.getDualViolationReal(dualviol, sumviol))
      {
         MSG_INFO1(soplex.spxout,
...
static
void printPrimalSolution(SoPlex& soplex, NameSet& colnames, NameSet& rownames, bool real = true,
                         bool rational = false)
{
   int printprec;
   int printwidth;
...
static
void printDualSolution(SoPlex& soplex, NameSet& colnames, NameSet& rownames, bool real = true,
                       bool rational = false)
{
   int printprec;
   int printwidth;
