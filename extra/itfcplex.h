/*@ ----------------------------------------------------------------------------
   ...
   Identification:
   $Id: itfcplex.h,v 1.1 2001/11/30 15:49:21 bzfkocht Exp $

   Program history:
   $Log: itfcplex.h,v $
   Revision 1.1  2001/11/30 15:49:21  bzfkocht
   Der Rest des alten cplex interfaces.

 * Revision 1.1.1.1  1995/03/31  14:53:53  bzfwunde
 * tested Version running with set packing
 *
 * Revision 1.1.1.1  1995/03/09  15:47:03  bzfwunde
 * Initial version:
 ...
 *
    ...
    ----------------------------------------------------------------------------
*/
#ifndef DEFspxcplex		/* prevent multiple includes	*/
#define DEFspxcplex
